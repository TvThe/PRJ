            ...
            <div class="body">
                ...
                <div class="login-box">
                    ...
                    <form action="login" method="POST" onsubmit="return validateForm()" name="myForm" required>
                        <div class="user-box">
                            <input type="text" name="username" height="20px;">
                            <label style="font-size: 15px; margin-bottom: 20px;">Username</label>
                        </div>
                        <div class="user-box">
                            <input type="password" name="password">
                            <label style="font-size: 15px; margin-bottom: 20px;">Password</label>
                        </div>
                        <a href="">
                            <span></span>
                            <span></span>
